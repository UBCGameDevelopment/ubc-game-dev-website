            ...
            {activeTab === "JOIN" && (
              ...
              >
                ...
                <div className="border border-[var(--border-dim)] bg-[var(--bg-deep)] p-5 text-center sm:p-6 md:p-8">
                  ...
                  <a
                    href="/contact"
                    className="clip-angled group/cta inline-flex w-full bg-[var(--cyber-blue)] p-px text-black transition-transform hover:scale-105 hover:bg-white hover:shadow-[0_0_20px_var(--cyber-blue)] sm:w-auto"
                  >
                    <span className="clip-angled flex w-full items-center justify-center gap-3 bg-[var(--cyber-blue)] px-5 py-4 text-center font-bold transition-[background-color] group-hover/cta:bg-white sm:px-8">
