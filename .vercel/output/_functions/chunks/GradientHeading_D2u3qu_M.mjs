import { c as createComponent, m as maybeRenderHead, r as renderTemplate, b as createAstro, d as addAttribute, f as renderSlot, a as renderComponent } from './astro/server_C2S9dwlY.mjs';
import 'piccolore';
import 'clsx';
...
const $$GradientHeading = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GradientHeading;
  const { as: Tag = "h2", class: className = "" } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Tag", Tag, { "class": `bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text font-extrabold tracking-tight text-transparent ${className}` }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })}`;
}, "/home/vvict/projects/ubc_game/club_site/src/components/common/Typography/GradientHeading.astro", void 0);

export { $$BaseCard as $, $$Badge as a, $$GradientHeading as b };
